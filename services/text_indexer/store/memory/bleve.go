...
import (
	...
	"not_your_fathers_search_engine/services/text_indexer/index"
...
// Search the index for a particular query and return
// back a result iterator
func (i *InMemoryBleveIndexer) Search(q index.Query) (index.Iterator, error) {
	...
	return &bleveIterator{idx: i, searchReq: searchReq, rs: res, cumIdx: q.Offset}, nil
}
